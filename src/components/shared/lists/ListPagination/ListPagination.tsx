...
export default function ListPagination({ baseHref, currentPage, totalPages }: { baseHref: string, currentPage: number, totalPages: number }) {
  return (
    <Flex
      justifyContent="space-between"
      mt={2}
    >
      <NextLink href={`${baseHref}?page=${currentPage - 1}`}>
